...
\begin{document}
	...
	\begin{figure}[ht]
		...
		\includegraphics[width=0.8\textwidth]{\basepath/fig6/domar_weights_data_vs_model_v2.eps}
		\label{fig:6}
	\end{figure}
	...
	\begin{figure}[ht]
		...
		\includegraphics[width=0.5\textwidth]{\basepath/fig7/correlation_cs.eps}
		\label{fig:7}
	\end{figure}
	...
	\begin{figure}[ht]
		...
		\begin{subfigure}[b]{0.48\textwidth} 
			...
			\includegraphics[width=\textwidth]{\basepath/fig8/EC_full_no_unc.eps}
			\label{fig:8-a}
		\end{subfigure}
		\hfill
		\begin{subfigure}[b]{0.48\textwidth}
			\caption{Left column: the ``the known $\varepsilon_t$'' alternative \\
				Difference in expected log GDP [\%]}
			\includegraphics[width=\textwidth]{\basepath/fig8/EC_full_known_shocks.eps}
			\label{fig:8-b}
		\end{subfigure}
		
		\begin{subfigure}[b]{0.48\textwidth} 
			\caption{Difference in expected st. dev. of log GDP [\%]}
			\includegraphics[width=\textwidth]{\basepath/fig8/VC_full_no_unc.eps}
			\label{fig:8-c}
		\end{subfigure}
		\hfill
		\begin{subfigure}[b]{0.48\textwidth}
			\caption{Difference in expected st. dev. of log GDP [\%]}
			\includegraphics[width=\textwidth]{\basepath/fig8/VC_full_known_shocks.eps}
			\label{fig:8-d}
		\end{subfigure}
		
		\begin{subfigure}[b]{0.48\textwidth} 
			\caption{Difference in expected welfare [\%]}
			\includegraphics[width=\textwidth]{\basepath/fig8/W_full_no_unc.eps}
			\label{fig:8-e}
		\end{subfigure}
		\hfill
		\begin{subfigure}[b]{0.48\textwidth}
			\caption{Difference in expected welfare [\%]}
			\includegraphics[width=\textwidth]{\basepath/fig8/W_full_known_shocks.eps}
			\label{fig:8-f}
		\end{subfigure}
		
		\begin{subfigure}[b]{0.48\textwidth} 
			\caption{Difference in realized log GDP [\%]}
			\includegraphics[width=\textwidth]{\basepath/fig8/C_full_no_unc.eps}
			\label{fig:8-g}
		\end{subfigure}
		\hfill
		\begin{subfigure}[b]{0.48\textwidth}
			\caption{Difference in realized log GDP [\%]}
			\includegraphics[width=\textwidth]{\basepath/fig8/C_full_known_shocks.eps}
			\label{fig:8-h}
		\end{subfigure}
	...
	\clearpage
		...
		morekeywords={break,case,catch,classdef,continue,else,elseif,end,for,function,global,if,otherwise,persistent,return,switch,try,while},
		emph={clc,clear,disp,fprintf,plot,subplot,figure,hold,grid,on,off,axis,equal,tight,legend,xlabel,ylabel,zlabel,title,tic,toc},
		emphstyle=\color{red},
		breaklines=true,
	...
	\lstdefinestyle{ST}{
		...
		frame=shadowbox,
		rulesepcolor=\color{red!20!green!20!blue!20},
		morekeywords={use,regress,reg,sum,display,dis,cd},
		emph={clear},
		emphstyle=\color{red},
		breaklines=true,
		flexiblecolumns=true,
...
No additional functions are called; all operations are performed using built-in Stata commands.
	\end{lstlisting}
	\lstinputlisting[style=ST]{\codepath/regressions/domar_volatility.do}
...
No additional functions are called; all operations are performed using built-in Stata commands.
	\end{lstlisting}
	\lstinputlisting[style=ST]{\codepath/regressions/data/FactSet_Revere/clean_factset_data.do}
...
No additional functions are called; all operations are performed using built-in Stata commands.
	\end{lstlisting}
	\lstinputlisting[style=ST]{\codepath/regressions/links_volatility.do}
...
No additional functions are called; all operations are performed using built-in MATLAB commands and the custom function `to_minimize` which is used to solve the optimization problem.
	\end{lstlisting}
	\lstinputlisting[style=Matlab]{\codepath/simulations/examples/Example_steel/main.m}
...
8. output: Calculates the objective function value based on the penalties for deviating from ideal shares, the costs associated with differences in input shares, and the total costs associated with the input shares and adjusted prices.
	\end{lstlisting}
	\lstinputlisting[style=Matlab]{\codepath/simulations/examples/Example_steel/to_minimize.m}
...
compute_eq: Custom function called to compute the equilibrium input shares given the parameters.
	\end{lstlisting}
	\lstinputlisting[style=Matlab]{\codepath/simulations/examples/Example_chain_safety/main.m}
...
solve_firm_problem: Custom function called within the loop to solve the optimization problem for each firm, given the current input shares. This function computes the optimal input shares for each firm.
	\end{lstlisting}
	\lstinputlisting[style=Matlab]{\codepath/simulations/examples/Example_chain_safety/compute_eq.m}
...
quadprog: MATLAB built-in function used to solve the quadratic programming problem.
	\end{lstlisting}
	\lstinputlisting[style=Matlab]{\codepath/simulations/examples/Example_chain_safety/solve_firm_problem.m}
...
No additional functions are called; all operations are performed using built-in MATLAB commands and the provided parameters.
	\end{lstlisting}
	\lstinputlisting[style=Matlab]{\codepath/simulations/examples/Example_chain_safety/a_alpha_star.m}
...
exportgraphics: MATLAB built-in function used to save the figures to files.
	\end{lstlisting}
	\lstinputlisting[style=Matlab]{\codepath/simulations/examples/Example_non_monotone/main.m}
...
solve_firm_problem: Custom function called within the loop to solve the optimization problem for each firm, given the current input shares. This function computes the optimal input shares for each firm.
	\end{lstlisting}
	\lstinputlisting[style=Matlab]{\codepath/simulations/examples/Example_non_monotone/compute_eq.m}
...
quadprog: MATLAB built-in function used to solve the quadratic programming problem.
	\end{lstlisting}
	\lstinputlisting[style=Matlab]{\codepath/simulations/examples/Example_non_monotone/solve_firm_problem.m}
...
No additional functions are called; all operations are performed using built-in MATLAB commands and the provided parameters.
	\end{lstlisting}
	\lstinputlisting[style=Matlab]{\codepath/simulations/examples/Example_non_monotone/a_alpha_star.m}
...
a_alpha_star: Custom function called to compute the equilibrium TFP term given the current input shares and parameters.
	\end{lstlisting}
	\lstinputlisting[style=Matlab]{\codepath/simulations/examples/Example_non_monotone/compute_moments.m}
...
Loading data using specific functions and then processing it using custom logic defined in Processdata.m.
	\end{lstlisting}
	\lstinputlisting[style=Matlab]{\codepath/data_work/SectorAggregateData/Code/Replication.m}
...
Logic to calculate TFP using various economic indicators and processing steps.
	\end{lstlisting}
	\lstinputlisting[style=Matlab]{\codepath/data_work/SectorAggregateData/Code/TFP.m}
...
Directory paths to locate and store comparison results.
	\end{lstlisting}
	\lstinputlisting[style=Matlab]{\codepath/data_work/SectorAggregateData/Code/Check.m}
...
Functions to copy and read data from Excel files based on specified criteria.
	\end{lstlisting}
	\lstinputlisting[style=Matlab]{\codepath/data_work/SectorAggregateData/Code/Getdata.m}
...
Processing steps to create consistent IO tables and depreciation rates.
	\end{lstlisting}
	\lstinputlisting[style=Matlab]{\codepath/data_work/SectorAggregateData/Code/LoadIOMat.m}
...
Functions to fetch and process data from various sources.	
	\end{lstlisting}
	\lstinputlisting[style=Matlab]{\codepath/data_work/SectorAggregateData/Code/Mergedata.m}
...
Functions to fetch and process data from various sources.
	\end{lstlisting}
	\lstinputlisting[style=Matlab]{\codepath/data_work/SectorAggregateData/Code/Processdata.m}
...
Logic to handle different variable types and store data accordingly.
	\end{lstlisting}
	\lstinputlisting[style=Matlab]{\codepath/data_work/SectorAggregateData/Code/Storedata.m}
...
Post-Calibration Analysis: The analysis_calib and analysis_fixed_rho_calib functions are used to perform post-calibration analysis if post_calib_flag is set to 1.
	\end{lstlisting}
	\lstinputlisting[style=Matlab]{\codepath/simulations/main_model/main.m}
...
results_correlations.m
	\end{lstlisting}
	\lstinputlisting[style=Matlab]{\codepath/simulations/main_model/analysis_calib.m}
...
compute_eq_time_series(epsilon, mu_drift, sigma_t, kappa, alpha_bar, rho, LS_min, beta, a0, known_shocks_flag, flag)
	\end{lstlisting}
	\lstinputlisting[style=Matlab]{\codepath/simulations/main_model/obj_calib_kappa.m}
...
compute_eq(kappa, alpha_bar, mu, sigma, rho, LS_min, beta, epsilon, A_bar, B_bar, C_bar, a0)
	\end{lstlisting}
	\lstinputlisting[style=Matlab]{\codepath/simulations/main_model/compute_eq_time_series.m}
...
10. `results_correlations.m`: Calculates and plots correlations between sectors.
	\end{lstlisting}
	\lstinputlisting[style=Matlab]{\codepath/simulations/main_model/bar_func.m}
...
10. `results_correlations.m`: Calculates and plots correlations between sectors.
	\end{lstlisting}
	\lstinputlisting[style=Matlab]{\codepath/simulations/main_model/a_alpha_star.m}
...
15. `a_alpha_star.m`: Computes equilibrium TFP term from input choice.
	\end{lstlisting}
	\lstinputlisting[style=Matlab]{\codepath/simulations/main_model/analysis_fixed_rho_calib.m}
...
16. `compute_eq_firm_iteration.m`: Iterates on the firm's problem to compute equilibrium input shares.
	\end{lstlisting}
	\lstinputlisting[style=Matlab]{\codepath/simulations/main_model/compute_eq.m}
...
solve_firm_problem.m: Solves the firm's problem to compute equilibrium input shares.
	\end{lstlisting}
	\lstinputlisting[style=Matlab]{\codepath/simulations/main_model/compute_eq_firm_iteration.m}
...
solve_firm_problem.m: Solves the firm's optimization problem.
	\end{lstlisting}
	\lstinputlisting[style=Matlab]{\codepath/simulations/main_model/compute_eq_time_series_alt_eps.m}
...
garch_tfp.m: Estimates GARCH coefficients for TFP data.
	\end{lstlisting}
	\lstinputlisting[style=Matlab]{\codepath/simulations/main_model/estimate_tfp.m}
...
garch_tfp.m: Estimates GARCH coefficients for TFP data.
	\end{lstlisting}
	\lstinputlisting[style=Matlab]{\codepath/simulations/main_model/garch_tfp.m}
...
garch_tfp.m: Estimates GARCH coefficients for TFP data.
	\end{lstlisting}
	\lstinputlisting[style=Matlab]{\codepath/simulations/main_model/hessian_func.m}
...
No external functions are called in this snippet.
	\end{lstlisting}
	\lstinputlisting[style=Matlab]{\codepath/simulations/main_model/load_data.m}
...
compute_eq_time_series.m: Function to compute equilibrium time series.
	\end{lstlisting}
	\lstinputlisting[style=Matlab]{\codepath/simulations/main_model/obj_calib_kappa_est.m}
...
quadprog: MATLAB function for quadratic programming.
	\end{lstlisting}
	\lstinputlisting[style=Matlab]{\codepath/simulations/main_model/solve_firm_problem.m}
